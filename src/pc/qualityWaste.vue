    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="table" :stripe="true">
          <el-table-column label="废料ID" prop="title"></el-table-column>
          <el-table-column label="废弃原因" prop="person"></el-table-column>
          <el-table-column label="重量" prop="user"></el-table-column>
